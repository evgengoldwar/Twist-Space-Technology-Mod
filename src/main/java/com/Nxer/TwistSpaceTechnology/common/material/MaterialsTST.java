...
//                .setHasCorrespondingPlasma(true);
public static Materials NeutroniumAlloy = new MaterialBuilder()
    .setName("NeutroniumAlloy")
    .setMetaItemSubID(offsetID)
    .setDefaultLocalName("NeutroniumAlloy")
    ...
    public static Materials AxonisAlloy = new MaterialBuilder()
        .setName("AxonisAlloy")
        .setMetaItemSubID(offsetID + 1)
        .setDefaultLocalName("AxonisAlloy")
        .setIconSet(TextureSet.SET_METALLIC)
        .setARGB(200)
        .setTool(0, 0, 0f)
        .setAutoGenerateBlastFurnaceRecipes(false)
    ...
    public static Materials Axonium = new MaterialBuilder()
        .setName("Axonium")
    ...
    public static Materials Dubnium = new MaterialBuilder()
        .setName("Dubnium")
