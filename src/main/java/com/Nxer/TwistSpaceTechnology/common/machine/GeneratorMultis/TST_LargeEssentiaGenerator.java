...
public class TST_LargeEssentiaGenerator extends GTCM_MultiMachineBase<TST_LargeEssentiaGenerator> {

    // region Class Constructor
    public TST_LargeEssentiaGenerator(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public TST_LargeEssentiaGenerator(String aName) {
        super(aName);
    }
    ...
    public int survivalConstruct(ItemStack stackSize, int elementBudget, ISurvivalBuildEnvironment env) {
        ...
        if (stackSize.stackSize == 1) {
            mSetTier = 1;
            built += this.survivialBuildPiece(STRUCTURE_PIECE_GAS, stackSize, horizontalOffSetGas, verticalOffSetGas, depthOffSetGas, elementBudget, env, false, true);
        } else {
            mSetTier = 2;
            built += this.survivialBuildPiece(STRUCTURE_PIECE_FUEL, stackSize, horizontalOffSetFuel, verticalOffSetFuel, depthOffSetFuel, elementBudget, env, false, true);
        }
        return built;
    }
    ...
    private static IStructureDefinition<TST_LargeEssentiaGenerator> STRUCTURE_DEFINITION = null;

    @Override
    public IStructureDefinition<TST_LargeEssentiaGenerator> getStructureDefinition() {
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<TST_LargeEssentiaGenerator>builder()
                ...
                .addElement(
                    'A',
                    ofChain(
                        buildHatchAdder(TST_LargeEssentiaGenerator.class)
                            .atLeast(Dynamo)
