...
public class TextLocalization {
    ...
    public static final String Tooltip_SpaceScaler_MachineType = texter("Compressor | Extractor | Particle Collider | Electric Implosion Compressor", "Tooltip_SpaceScaler_MachineType");
    ...
    public static final String Tooltip_DSPReceiver_02_08 = texter("Final requesting power point limit = Astral Array Fabricator amount^2 * 2048A Max", "Tooltip_DSPReceiver_02_08");
    ...
    public static final String NameFackRackHatch = texter("rack simulation hack", "NameFackRackHatch");
